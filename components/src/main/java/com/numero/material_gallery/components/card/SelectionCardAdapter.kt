...
import com.numero.material_gallery.components.databinding.ViewHolderCardBinding

class SelectionCardAdapter : RecyclerView.Adapter<SelectionCardAdapter.CardViewHolder>() {

    private val itemList: List<SelectionCardItem> = (0..10).map {
        SelectionCardItem(R.drawable.ic_android, "Card $it")
    }
